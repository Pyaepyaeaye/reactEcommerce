          ...
          <div class="row">              
              <div class="col-md-6 col-sm-12">            
                ...
                <div class="form-group">
                  ...
                  <input type="number" name="total_qty" id="" class="form-control"  value="{{ $product->total_qty }}">
                </div>
                @error('total_qty')
                <div class="mb-2">
                  <span class="text-danger font-weight-bold"> {{ $message }}</span>  
                ...
                <div class="form-group">
                  ...
                  <input type="number" name="buy_price" id="" class="form-control" value="{{ $product->buy_price }}">
                </div>
                @error('buy_price')
                <div class="mb-2">
                  <span class="text-danger font-weight-bold"> {{ $message }}</span>  
                ...
                <div class="form-group">
                  ...
                  <input type="number" name="discount_price" id="" class="form-control" value="{{ $product->discount_price }}">
                </div>
